...
conan_server_config_file_default = '/root/.conan_server/server.conf'
conan_server_config_file = os.environ.get("CONAN_SERVER_CONFIG_FILE", conan_server_config_file_default)
